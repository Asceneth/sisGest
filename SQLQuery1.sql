...
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Maria', N'Gomez', 50, 1)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Jose', N'Sarta', 100, 2)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Miguel', N'Romero', 30, 3)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Lorena', N'Duque', 150, 4)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Rafael', N'Jimenez', 25, 5)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Laura', N'Real', 200, 6)
GO
INSERT [dbo].[TBL_Alumno] ([ALM_Nombres], [ALM_Apellidos], [ALM_Creditos], [PK_ALM_IdAlumno]) VALUES (N'Johan', N'Gutierrez', 150, 7)
GO
...
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Calculo I', NULL, NULL, 1, 1)
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Fisica de ondas', NULL, NULL, 4, 2)
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Danza', NULL, NULL, 3, 3)
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Ingeniería de software', NULL, NULL, 5, 4)
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Mantenimiento de computadores', NULL, NULL, 5, 5)
GO
...
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Quimica inorganica', NULL, NULL, 1, 7)
GO
INSERT [dbo].[TBL_Materia] ([MTR_Nombre], [MTR_Modulo], [MTR_Curso], [FK_PGM_IdPrograma], [PK_MTR_IdMateria]) VALUES (N'Derecho civil', NULL, NULL, 2, 8)
GO
